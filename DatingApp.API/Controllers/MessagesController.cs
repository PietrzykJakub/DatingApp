...
namespace DatingApp.API.Controllers
{
    ...
    public class MessagesController : ControllerBase
    {
        ...
        public MessagesController(IDatingRepository repo, IMapper maper)
        {
            _maper = maper;
            _repo = repo;
        ...
        public async Task<IActionResult> GetMessageForUser(int userId, [FromQuery]MessageParams messageParams)
        {
            ...
            var messages = _maper.Map<IEnumerable<MessageToReturnDto>>(messagesFromRepo);
        ...
        public async Task<IActionResult> GetMessageThread(int userId, int recipientId)
        {
            ...
            var messageThread = _maper.Map<IEnumerable<MessageToReturnDto>>(messageFromRepo);
        ...
        public async Task<IActionResult> CreateMessage(int userId, MessageForCreationDto messageForCreationDto)
        {
            ...
            var message = _maper.Map<Message>(messageForCreationDto);
            _repo.Add<Message>(message);

            if (await _repo.SaveAll())
            {
                var messageToReturn = _maper.Map<MessageToReturnDto>(message);
